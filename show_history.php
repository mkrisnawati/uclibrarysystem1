...
$query_rec_show_kembali = "SELECT p_transaksi.t_id as AA, p_transaksi.t_idanggota, p_transaksi.t_kdbuku as AB, p_buku.b_kode as AC, p_buku.b_judul as AD, p_buku.b_penerbit as AE, p_transaksi.t_jumlah as AF, p_transaksi.t_tgl1 as AH, p_transaksi.t_tgl2 as AI,p_transaksi.t_kembali as AJ, p_anggota.a_id, p_anggota.a_nama as AK, p_transaksi.t_jmlDenda as AL,  p_transaksi.t_tgl3 as AM FROM p_transaksi,p_anggota,p_buku WHERE p_transaksi.t_idanggota=p_anggota.a_id AND p_buku.b_kode=p_transaksi.t_kdbuku AND p_transaksi.t_kembali='Y' ORDER BY p_transaksi.t_id DESC";
...
<table class="gridtable" border="0" cellpadding="2">
  ...
  <?php $no=0; do { $no++;?>
    <tr>
      ...
      <td><?php echo $row_rec_show_kembali['AM']; ?></td>
      <td><?php echo $row_rec_show_kembali['AL']; ?></td>
      <td>
...
<p><img src="images/t_Y.png" width="16" height="16" /> Telah Kembali</p>
